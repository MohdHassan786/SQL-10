...
<body>
    ...
    <form id="form1" runat="server">             
        <div class="row">
             <div class="col-md-2"><asp:Image runat="server" ID="Image1" ImageUrl="~/Images/img1.jpg"
                 Width="500" Height="150" CssClass="img-fluid" /></div>
             <div class="col-md-2" style="margin-left : 150px"><asp:Image runat="server" ID="Image2" ImageUrl="~/Images/img2.jpg"
                 Width="500" Height="150" CssClass="img-fluid" /></div>            
         </div>
